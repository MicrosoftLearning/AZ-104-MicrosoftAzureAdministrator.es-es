...
1. Seleccione **Habilitar** junto a la máquina virtual.

1. Tome los valores predeterminados, seleccione **Revisar y habilitar** y, a continuación **, Habilitar**.  
...
1. Siga trabajando en la alerta. Vaya a la pestaña **Acciones**, seleccione **Usar grupos de acciones** y, a continuación, seleccione **Crear grupo de acciones** en la hoja **Seleccionar grupo de acciones**.
